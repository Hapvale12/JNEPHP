            ...
            <form id="contactForm" class="space-y-5">
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="w-full">
                        ...
                        <input type="text" id="nombre" name="nombre" maxlength="20" {{-- Ajustado a 20 para consistencia con backend --}}
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" id="apellidos" name="apellidos" maxlength="20" {{-- Ajustado a 20 para consistencia con backend --}}
                            pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+" required
                            class="bg-[#e7e7e7] w-full border border-white rounded px-4 py-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-400"
                            title="Solo se permiten letras y un máximo de 20 caracteres"
                            value="{{ old('apellidos') }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const termsConditionsCheckbox = document.getElementById('terms_conditions'); // NUEVO: Obtener el checkbox
        const termsErrorDiv = document.getElementById('termsError'); // NUEVO: Mensaje de error para el checkbox
        ...
        function hideAllMessages() {
            ...
            termsErrorDiv.classList.add('hidden'); // NUEVO: Ocultar error de términos
        }
        ...
        contactForm.addEventListener('submit', function(event) {
            ...
            if (!termsConditionsCheckbox.checked) {
                termsErrorDiv.classList.remove('hidden');
                submitBtn.disabled = false; // Asegurarse de que el botón no quede deshabilitado si falla esta validación
            ...
            fetch('{{ route('
                ...
                .then(data => {
                    ...
                    termsConditionsCheckbox.checked = false; // NUEVO: Asegurar que el checkbox se desmarque al resetear
                })
                .catch(error => {
